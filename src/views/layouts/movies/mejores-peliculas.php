...
<!-- Póster de películas. -->
<figure class="row movie-poster">
  <!--
    Contenedor para que el año tenga posición relativa al póster y
    no a todo el contenedor.
  -->
  <div class="movie-poster__year-image col-5 col-sm-4 col-md-5 col-lg-6">
  ...
  <figcaption class="col-7 col-sm-8 col-md-7 col-lg-6">
...
<figure class="row movie-poster">
  <!--
    ...
    no a todo el contenedor.
  -->
  <div class="movie-poster__year-image col-6  col-md-5 col-lg-6">
    <a rel="noopener noreferrer" href="<?php echo VIEWS_FOLDER; ?>peliculas/detalles-pelicula/index.php?id=id_pelicula" class="">
  ...
  <figcaption class="col-6 col-md-7 col-lg-6">
    <ul class="best-movies__details-list">
